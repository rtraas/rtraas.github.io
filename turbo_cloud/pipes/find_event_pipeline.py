...
def cmd_utility(args=None):
    ...
    P.add_argument('-f', '--dats_lst', action='store', default=None, dest='dat_file_list', type=str, required=True)
    ...
    if args.dat_file_list is None:
        print('Need to indicate input event file path')
        sys.exit()
